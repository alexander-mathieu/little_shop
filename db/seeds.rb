...
a1 = user_1.addresses.create(zip: "Zip 1", address: "Address 1", state: "CO", city: "Fairfield")
user_1.addresses.create(nickname: "Nickname 1", zip: "Zip 2", address: "Address 2", state: "OK", city: "Tulsa")
a2 = user_2.addresses.create(zip: "Zip 3", address: "Address 3", state: "IA", city: "Fairfield")
user_2.addresses.create(nickname: "Nickname 2",zip: "Zip 2", address: "Address 2", state: "OK", city: "Tulsa")
a3 = user_3.addresses.create(zip: "Zip 3", address: "Address 3", state: "IA", city: "Fairfield")
user_3.addresses.create(nickname: "Nickname 3",zip: "Zip 4", address: "Address 4", state: "IA", city: "Des Moines")
a4 = user_4.addresses.create(zip: "Zip 5", address: "Address 5", state: "IA", city: "Des Moines")
user_4.addresses.create(nickname: "Nickname 4",zip: "Zip 6", address: "Address 6", state: "IA", city: "Des Moines")
...
order_1 = create(:shipped_order, user: user_1, address: a1)
create(:fulfilled_order_item, order: order_1, item: item_1, price: 1, quantity: 6, created_at: (rng.rand(3)+1).days.ago, updated_at: rng.rand(59).minutes.ago)
...
order_2 = create(:shipped_order, user: user_2, address: a2)
create(:fulfilled_order_item, order: order_2, item: item_1, price: 1, quantity: 8, created_at: (rng.rand(3)+1).days.ago, updated_at: rng.rand(59).minutes.ago)
...
order_3 = create(:shipped_order, user: user_3, address: a3)
...
order_4 = create(:shipped_order, user: user_4, address: a4)
...
order_5 = create(:order, user: user_1, address: a1)
create(:order_item, order: order_5, item: item_1, price: 1, quantity: 10)
...
order_6 = create(:cancelled_order, user: user_2, address: a2)
...
order_7 = create(:shipped_order, user: user_3, address: a3)
...
order_8 = create(:packaged_order, user: user_4, address: a4)
